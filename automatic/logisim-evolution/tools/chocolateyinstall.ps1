...
$packageArgs = @{
  ...
  url           = 'https://github.com/logisim-evolution/logisim-evolution/releases/download/v3.7.2/logisim-evolution-3.7.2-all.jar'
  checksum      = '448fa2a0e1e3d775001ae3f3b1e000cb7a100506248dafee7238f840c791661c'
  checksumType  = 'sha256'
}
